        ...
        >
            ...
            <div class="flex flex-wrap w-full gap-4 max-w-4xl">
                <div class="flex flex-col gap-1 w-full text-sm">
                    <label for="like">Dodatkowe uwagi</label>
                    <textarea
                        type="text"
                        name="other_notes"
                        class="w-full rounded-md bg-[#FFF] border-[1px] border-slate-400 p-2 resize-none h-24 text-sm"
        ...
        <div class="flex flex-wrap gap-4">
            ...
            >
                ...
                <div class="flex flex-col gap-2">
                    ...
                    >
                        <span class="font-medium"
                            ><i class="fa-solid fa-utensils text-[#49AA39]"></i>
                            Typ diety:
                        </span>
                        @if($diet->type === 'keto') Ketogeniczna
                        @elseif($diet->type === 'wegan') Wegetariańska
                        @elseif($diet->type === 'classic') Klasyczna @endif
                    </p>
                    <p
                        class="text-sm flex items-center w-full justify-start gap-1"
                    >
                        <span class="font-medium"
                            ><i class="fa-solid fa-bolt text-[#49AA39]"></i>
                            Ilość kalorii:
                        </span>
                        {{ $diet->kcal }}
                    </p>
                    ...
                    >
                        <span class="font-medium"
                            ><i
                                class="fa-solid fa-bowl-food text-[#49AA39]"
                            ></i>
                            Ilość posiłków:</span
                        >
                        {{ $diet->dishes_count }}
                    ...
                    >
                        <span class="font-medium"
                            ><i
                                class="fa-solid fa-circle-xmark text-[#49AA39]"
                            ></i>
                ...
                <div class="flex flex-wrap gap-2">
                    <button
                        class="show-diet rounded-md bg-[#49AA39] text-white px-6 py-2 text-base w-28 duration-200 hover:bg-[#2E8B56]"
                    >
                        Zobacz
                    </button>
...
>
    <h2
        class="text-xl font-medium text-[#49AA39] text-center pb-4 border-b-[1px] border-gray-100"
    >
        {{ $diet->name }}
    </h2>
