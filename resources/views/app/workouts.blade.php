    ...
    >
        <div class="flex flex-col gap-2">
            ...
            <span class="text-xs text-gray-400 font-normal"
                >Dostosuj parametry swojej workouty. Wirtualny asystent bierze
            ...
            <div class="flex flex-wrap w-full gap-4 max-w-4xl">
                ...
                >
                    <label for="workout_type" class="dark:text-white"
                        >Typ workouty <span class="text-red-500">*</span></label
                    >
                    <select
                        type="text"
                        name="workout_type"
            ...
            >
                ...
                <div class="flex flex-col gap-2">
                    ...
                    >
                        ...
                        @elseif($workout->target === 'gain') Zwiększenie masy
                        mięśniowej @endif
                    </p>
                    <p
                        class="text-sm flex items-center w-full justify-start gap-1"
            ...
            >
                ...
                <div class="flex flex-col gap-2">
                    ...
                    >
                        ...
                        @elseif($workout->workout_type === 'gain') Zwiększenie
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <form
                        class="flex justify-center items-center"
                        action="{{ route('workout.forceDestroy', $workout) }}"
                        method="post"
                    >
                        @csrf @METHOD('DELETE')
                        <button
