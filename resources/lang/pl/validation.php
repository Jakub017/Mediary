...
return [
    ...
    */
    ...
    'custom' => [
        'diet_name' => [
            'required' => 'Należy wprowadzić nazwę diety',
            'max' => 'Nazwa diety nie może mieć więcej niż 64 znaków',
        ],
        'diet_type' => [
            'required' => 'Należy wybrać typ diety',
        ],
        'meals_count' => [
            'required' => 'Należy wybrać ilość posiłów',
        ],
        'diet_kcal' => [
            'required' => 'Należy wybrać ilość kalorii',
        ],
    ],
